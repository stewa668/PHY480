...
//  cin >> N;
  ...
  ofstream eigout ("eigen_tridiagonal2.dat");
  for (int N = 4; N <= 1024; N *= 2)
      ...
      for (int i = 1; i <= 3; i++)
	{
	  ...
	  if (i == 1)
	    {
	      //ofstream eigout ("eigen_tridiagonal2.dat");  // open an output file
	      ...
	      //     << scientific << log10((gsl_vector_get (eigenvector_ptr, j-1) - 1.5)/1.5) << endl;
	      //}
