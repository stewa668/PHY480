...
value_list2 = [1, 2, 3, 4, 5]

# Ok, let's do it . . .
print "\nFirst try a list of integers:"

for i in range(len(value_list1)):    # don't forget the colon!
  my_command = "./area_cmdline.x " + str(value_list1[i]) + " " + str(value_list2[i])  # convert radius to a string
  print my_command
